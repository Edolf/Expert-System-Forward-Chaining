<div id="editProblemModal" tabindex="-1" aria-labelledby="editProblemModalLabel" aria-hidden="true" class="Judd_197 Avery_140 Garrison_477">
      ...
      <form method="POST" id="editProblemForm" onsubmit="sulaiForm({this:this,event:event,link:this.action,method:'PUT'})">
        <div class="Daiana_395 Mattison_196">
          ...
          <div class="Zephyr_231 Safwan_346 Aurora_187 Cherish_137">
            <h5 class="Faizan_466">Edit <strong>Problems</strong></h5>
          </div>
          ...
          <div class="Calen_148">
            <div class="Izzabella_317 Jana_232 Xavien_336 Preston_343 Safwan_346">
              ...
              <h6 for="editproblemname" class="Raena_142 Gotham_178"><strong>Problem</strong></h6>
            </div>
            <div class="Mayer_323">
              <div class="Mariano_448 Mckenzie_188">
                <input id="editproblemname" name="editproblemname" type="text" data-length="25" class="Amen_518 Simcha_314" />
          ...
          <div class="Calen_148">
            <div class="Izzabella_317 Jana_232 Xavien_336 Preston_343 Safwan_346">
              ...
              <h6 for="editproblemdesc" class="Raena_142 Gotham_178"><strong>Descriptions</strong></h6>
            </div>
            <div class="Mayer_323">
              <div class="Mariano_448 Mckenzie_188">
                <textarea id="editproblemdesc" name="editproblemdesc" type="text" data-length="500" class="Amen_518 Justus_576 Simcha_314"></textarea>
          ...
          <div class="Calen_148 Safwan_346 Mckenzie_188 Jermani_171">
            <div class="Gaston_216 Zephyr_231 Talaya_354">
              <button type="button" data-dismiss="modal" class="Zakai_128 Kepler_361">Close</button>
              <button type="submit" class="Zakai_128 Kepler_361 Pascual_265 Zephyr_231 Preston_343 Safwan_346">
