<div id="addProblemModal" tabindex="-1" aria-labelledby="addProblemModalLabel" aria-hidden="true" class="_31P-8 _3bCgx">
      ...
      <form method="POST" id="newProblemform" onsubmit="sulaiForm({this:this,event:event,link:'<?= LINK ?>/members/getproblem',method:'POST'})">
        <div class="_3tByX _1jkJg">
          ...
          <div class="_1dTWr _3x-l5 _1HqFl _3mxtc">
            <h5 class="_3znGg">Add New <strong>Problems</strong></h5>
          </div>

          <div class="_3Sail">
            <div class="_18uPx _14vxW _3e0Cs _2kea1 _3x-l5">
              <svg width="24" height="24" fill="currentColor" class="_2i-WK">
                <use xlink:href="<?= ROOT ?>/assets/bootstrap-icons/bootstrap-icons.svg#book-half" />
              </svg>
              <h6 for="problemname" class="_10lSW _1x6Xu"><strong>Problem</strong></h6>
            </div>
            <div class="_3BRUK">
              <div class="_2E95Y riVBJ">
                <input id="problemname" name="problemname" type="text" data-length="25" class="_1y8Oi _1GV_i" />
          ...
          <div class="_3Sail">
            <div class="_18uPx _14vxW _3e0Cs _2kea1 _3x-l5">
              <svg width="24" height="24" fill="currentColor" class="_2i-WK">
                <use xlink:href="<?= ROOT ?>/assets/bootstrap-icons/bootstrap-icons.svg#file-text-fill" />
              </svg>
              <h6 for="problemdesc" class="_10lSW _1x6Xu"><strong>Descriptions</strong></h6>
            </div>
            <div class="_3BRUK">
              <div class="_2E95Y riVBJ">
                <textarea id="problemdesc" name="problemdesc" type="text" data-length="500" class="_1y8Oi _142t1 _1GV_i"></textarea>
