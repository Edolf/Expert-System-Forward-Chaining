<div id="editSymptomModal" tabindex="-1" aria-labelledby="editSymptomModalLabel" aria-hidden="true" class="_2yvo3 _3F0Yh">
      ...
      <form method="POST" id="editSymptomForm" onsubmit="sulaiForm({this:this,event:event,link:this.action,method:'PUT'})">
        <div class="_3BAVP _3TCQr">
          ...
          <div class="_1wHD0 _3Yl2j _2WrBi XgJiO">
            <h5 class="RogPM">Edit <strong>Symptoms</strong></h5>
          </div>
          ...
          <div class="SiBSM">
            <div class="_1Nnzl rCKpP _3eiVE _1uVtA _3Yl2j">
              ...
              <h6 for="editsymptomname" class="_3MkHC _23PWi"><strong>Symptom</strong></h6>
            </div>
            <div class="_20qFt">
              <div class="_36R48 DLDJz">
                <input id="editsymptomname" name="editsymptomname" type="text" data-length="50" class="_21QBy _2fCo5" />
          ...
          <div class="SiBSM">
            <div class="_1Nnzl rCKpP _3eiVE _1uVtA _3Yl2j">
              ...
              <h6 for="editsymptomdesc" class="_3MkHC _23PWi"><strong>Description</strong></h6>
            </div>
            <div class="_20qFt">
              <div class="_36R48 DLDJz">
                <textarea id="editsymptomdesc" name="editsymptomdesc" type="text" data-length="500" class="_21QBy _2wuGa _2fCo5"></textarea>
          ...
          <div class="SiBSM">
            <div class="_1Nnzl rCKpP _3eiVE _1uVtA _3Yl2j">
              ...
              <h6 for="editquestion" class="_3MkHC _23PWi"><strong>Question</strong></h6>
            </div>
            <div class="_20qFt">
              <div class="_36R48 DLDJz">
                <textarea id="editquestion" name="editquestion" type="text" data-length="100" class="_21QBy _2wuGa _2fCo5"></textarea>
