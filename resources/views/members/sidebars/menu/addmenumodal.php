<div id="addMenuModal" tabindex="-1" aria-labelledby="addMenuModalLabel" aria-hidden="true" class="_2yvo3 _3F0Yh">
  <div class="EGnm1">
    <div class="xo4Q- _3Znxg _1Mqcp _3W_HJ _2W81z">
      <div class="_1dR9f">
        <h5 id="addMenuModalLabel" class="_1XL6n">Add New Sidemenu</h5>
      </div>
        ...
        <div class="_3BAVP">
          ...
          <div class="_36R48">
            <div class="SiBSM">
              <div class="_1yUFw">
                <div class="_36R48">
                  <input type="text" id="newMenu" name="newMenu" class="_21QBy _2fCo5" />
